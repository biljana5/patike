...
<script>
 $(document).ready(function(){
    $("#nazivbrenda").change(function(){
      var vrednost = $("#nazivbrenda").val();
      $.get("ucitajproizvod2.php", { id: vrednost },
     function(data){
       $("#proizvod").html(data);
     });
    });
...
<script>
 $(document).ready(function(){
    $("#svi").click(function(){
       $("#proizvod").load("ucitajproizvod3.php");
     });
    });
...
?>
        ...
        <div class="col-md-2 col-sm-4 sidebar1">
            ...
            <br>
              <div class="left-navigation">
                ...
                <a class="nav-link active" id="svi" name="svi" href="#" style="color:white">SVI PROIZVODI</a>
                <ul class="list">
                <h5><strong>BREND</strong></h5> </ul>
                
                <select class="form-control" name="brendovi" id="nazivbrenda">
                <option selected disabled value="">Izaberite brend...</option>
                   <?php
                   $sql="SELECT * FROM brend ORDER BY naziv";
                   $crud->select2($sql);
                 while($red = $crud->getResult()->fetch_object()){
                  ...
                  ?>
                    ...
                    <ul class="list">
                        <h5><strong>POL</strong></h5>
                        <li class="nav-item">
                           <a class="nav-link active" href="#" style="color:white">Muški</a>
                         </li>
                         <li class="nav-item">
                           <a class="nav-link active" href="#" style="color:white">Ženski</a>
                         </li>
                    </ul>
              </div>
          </div>
  ...
  <div id="proizvod" class="col-md-10 col-sm-9 col-sm-9 main-content" style="padding-top:10px">
  
  <?php include "ucitajProizvod.php";?>
