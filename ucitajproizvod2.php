...
if (!isset ($_GET["id"])){
    ...
    $rezultatapostrani=3;
    $sql="SELECT * FROM proizvodi p join brend b on p.idbrend=b.idbrenda WHERE b.naziv='" . $pomocna . "'";
            $crud->select2($sql);
    ...
    $brojod=($strana-1)*$rezultatapostrani;
            ...
            $sql="SELECT * FROM proizvodi p join brend b on p.idbrend=b.idbrenda WHERE b.naziv='" . $pomocna . "' LIMIT " . $brojod . ',' . $rezultatapostrani;
            $crud->select2($sql);
 ...
 <nav aria-label="Page navigation example">
  ...
  <li class="page-item"><a class="page-link" href="#">Previous</a></li>
   ...
   <?php
    ...
    echo ' <a class="page-link" href="#">' . $strana . '</a>';
    ?>
    </li>
